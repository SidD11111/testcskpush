...
(function($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    init: function() {
      ...
      var date = new Date();
      date.setMonth(this.settings.month);
      date.setFullYear(this.settings.year);
      var todayDate = date;
    ...
    buildCalendar: function(fromDate, calendar) {
      var events = this.settings.event;
      console.log(events);
      var plugin = this;
      ...
      for (var day = firstDay; day <= lastDay; day.setDate(day.getDate())) {
        ...
        for (var i = 0; i < 7; i++) {
          ...
          var dayStr = day.getFullYear() + "-" + month + "-" + dateNum;

          var td = $(
            '<td><a href="#" meta="' +
              day.toDateString() +
              '" onclick="dayClicked(this)" class="day">' +
              day.getDate() +
              "</a></td>"
          );
          if (events.includes(dayStr)) {
            td = $(
              '<td class="event"><a href="#" meta="' +
                day.toDateString() +
                '" onclick="dayClicked(this)" class="day">' +
                day.getDate() +
                "</a></td>"
